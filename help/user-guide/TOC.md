...
+ テンプレート {#templates}
   ...
   + [&#x200B; アクセス可能なテンプレートを作成](templates/accessibility-for-templates.md)
...
+ 統合 {#integrations}
   ...
   + [GenStudio Photoshop プラグイン &#x200B;](integrations/photoshop-plugin.md)
