...
1. _[!DNL Activate]_&#x200B;から、メタ製品タイルの&#x200B;**[!UICONTROL 新規]**&#x200B;をクリックします。_ Creative設定 _ビューが開きます。
...
1. _[!DNL Activate]_&#x200B;から、メタ広告タイルの&#x200B;**[!UICONTROL 新規]**&#x200B;をクリックします。_ Creative設定 _ビューが開きます。
...
アップロードに失敗すると、_[!DNL Content]_&#x200B;内のアセットへのリンクを含む情報エラーメッセージが開きます。

**外部アセットをアップロードするには**:

Microsoft OneDrive またはDropboxから、_[!DNL Content]_&#x200B;ギャラリーの外部に最大 6 つの静的画像をアップロードできます。

1. _[!DNL Activate]_&#x200B;から、メタタイルの&#x200B;**[!UICONTROL 新規]**&#x200B;をクリックします。_ Creativeの設定 _ウィンドウが開きます。
...
_レビュー_ ページには、_Creativeの設定で組み合わせた広告エクスペリエンスが表示され_ 最終的にエクスペリエンスを表示および編集する機会が提供されます。 **[!UICONTROL 2&rbrace;Creative設定]** ラベルの横にある「&lbrace; 編集セクション _をクリックして、変更を加えます。_&#x200B;また、右上の **[!UICONTROL 戻る]** をクリックして、_Creative設定_ ページに戻ることもできます。
