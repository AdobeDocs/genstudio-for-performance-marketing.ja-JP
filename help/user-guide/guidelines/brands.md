...
| ------------------| --------- | --------- | -------- |
| 一般 | メール、メタ、ディスプレイ広告 | 2 つ目の件名行またはメールのプレビューテキスト | メール全体で一貫した全体的なトーン/感情を定義する（2～5 つのガイドライン）。<br>_例_:「友好的で親しみやすいトーンを維持する」、「過度に正式な言語は避ける」 <br><br> |
...
| 見出し | メール，メタ，ディスプレイ広告，LinkedIn | 読者の注意を引くためのタイトルまたはフレーズ | トーン、理想的な長さなどについて、具体的なガイダンス（2～5 のガイドライン）を提供します。 以前に成功したヘッドラインを _例_ セクションに追加すると、より良い品質出力が得られます。<br>_例_:「パンチの効いたステートメントを使用して注目を集める」 |
| サブ見出し | メール、広告の表示 | 読者の注意を引くための 2 番目または 3 番目のタイトルまたはフレーズ | トーン、理想的な長さなどを定義した具体的なガイダンス（2～5 のガイドライン）を提供します。 以前に成功したサブヘッドラインを _例_ セクションに追加すると、より良い品質出力が得られます。<br>_例_:「パンチの効いたステートメントを使用して注目を集める」 |
...
| 本文 | メール，メタ，ディスプレイ広告，LinkedIn | メッセージ、リンク、画像を含むマーケティングコンテンツ | トーン、理想的な長さなどについて、具体的なガイダンス（2～5 のガイドライン）を提供します。 以前に成功したコピーを _例_ セクションに追加すると、出力の品質が向上します。<br>_例_:「80～100 文字に制限」、「過度の頭字語を避ける」 |
...
| コールトゥアクション（CTA） | メール、メタ、ディスプレイ広告 | （コールトゥアクション）読み手に与えられた、応答を促す指示。 通常、`Get started` などの 1 つまたは 2 つの単語 | トーン、理想的な長さなどについて、具体的なガイダンス（2～5 のガイドライン）を提供します。 以前に成功した CTA を _例_ セクションに追加すると、品質の出力が向上します。<br>_例_:「終了句読点を使用しない」 |
