...
| ------------------| :---------- | :---------- |
| [!UICONTROL  声のトーン ] | 書面によるコミュニケーションで表現したブランドの個性 | ブランドの感情やトーンを明確に伝えるには、説明的な単語を使用します。<br>_例_:「純正品」、「遊び心」 <br><br> 簡潔に（3～6 のガイドライン）、主要なブランド音声属性に焦点を当てます。<br><br> コミュニケーションチャネル全体で一貫性のある単語やフレーズを選択して、一貫性のあるブランドアイデンティティを構築します。 |
| [!UICONTROL  ブランド価値 ] | ブランド文化、顧客体験、ビジネス戦略を推進する原則 | ブランドの使命、ビジョン、オーディエンスのニーズを伝えるために、説明的な単語を使用します。<br>_例_:「信憑性」、「インスピレーション」、「プログレッシブ」 <br><br> 簡潔に（3～6 個のガイドライン）、コアブランドの価値やテーマに焦点を当てます。 |
| [!UICONTROL  エディトリアルガイドライン ] | ブランドメッセージを作成するためのベストプラクティスを定義するコミュニケーションガイドライン | 正の表現（5 ～ 10 のガイドライン）を使用して、強力な基盤を確立します。<br>_例_:「専門用語の使用を避ける」ではなく、「シンプルでアクセスしやすい言語を使用する」 <br><br> 明確で実用的なガイダンスを提供します。<br>_例_:「簡潔にする」ではなく「文を 20 語未満に保つ」 <br><br> 特定の構文環境設定を使用するなど、ブランドのスタイルを反映します。<br>_例_:「コロンの代わりに EM ダッシュを使用」、「文頭ケースを使用」 <br><br> 出力間の一貫性を維持する正確なガイドラインを作成します。 |
| [!UICONTROL  編集上の制限 ] | ブランドメッセージで避けるべきことを定義するコミュニケーションガイドライン | 何を避けるべきかを指定するには、負の直接語句（5～10 のガイドライン）を使用します。<br>_例_:「使用を避ける」 <br><br> 明確で実用的なガイダンスを提供する。<br>_例_:「修辞的な質問を避ける」 |
...
| ------------------| --------- | --------- | -------- |
| 一般 | メール、Meta、バナー、ディスプレイ広告 | 2 つ目の件名行またはメールのプレビューテキスト | メール全体で一貫した全体的なトーン/感情を定義します（2～5 つのガイドライン）。<br>_例_:「友好的で親しみやすいトーンを維持」、「過度に形式的な言語を避ける」 <br><br> |
| 件名 | メール | メールのコンテンツをまとめるための、説得力のある興味深いタイトル | トーン、長さなどに関する具体的なガイダンス（2～5 のガイドライン）を提供します。以前に成功した件名行を _例_ セクションに追加して、より高品質な出力を実現します。<br>_例_:「件名をメール本文に合わせる」 |
...
| 見出し | メール、Meta、バナーおよびディスプレイ広告、LinkedIn | 読者の注意を引くためのタイトルまたはフレーズ | トーン、理想的な長さなどについて、具体的なガイダンス（2～5 のガイドライン）を提供します。以前に成功したヘッドラインを _例_ セクションに追加して、より高品質な出力を実現します。<br>_例_:「パンチの効いたステートメントを使用して注目を集める」 |
| サブ見出し | メール、バナー、ディスプレイ広告 | 読者の注意を引くための 2 番目または 3 番目のタイトルまたはフレーズ | トーン、理想的な長さなどを定義した具体的なガイダンス（2～5 のガイドライン）を提供します。以前に成功したサブヘッドラインを _例_ セクションに追加して、より高品質な出力を実現します。<br>_例_:「パンチの効いた文を使用して注目を集める」 |
| 説明 | LinkedIn | 全体的なトーン感情を定義する説明的なフレーズ | トーン、理想的な長さなどについて、具体的なガイダンス（2～5 のガイドライン）を提供します。以前に成功した説明を _例_ の節に追加して、品質の高い出力を実現します。<br>_例_:「わかりやすい親しみやすいトーンを維持する」 |
| 本文 | メール、Meta、バナーおよびディスプレイ広告、LinkedIn | メッセージ、リンク、画像を含むマーケティングコンテンツ | トーン、理想的な長さなどについて、具体的なガイダンス（2～5 のガイドライン）を提供します。以前に成功したコピーを _例_ セクションに追加して、より高品質な出力を実現します。<br>_例_:「80～100 文字に制限」、「過度の頭字語を避ける」 |
| 画像上のテキスト | Meta, LinkedIn | 画像の上に表示されるテキストのトーン、理想的な長さなどに関する具体的なガイダンス | トーン、理想的な長さなどに関する具体的なガイダンス（1～2 文）を提供します。以前に成功したテキストを _例_ セクションに追加して、より高品質な出力を実現します。<br>_例_:「瞬間に集中する」 |
| Call-to-action（CTA） | メール、Meta、バナー、ディスプレイ広告 | （Call to action）読み手に与えられる指示で、回答を促すもの。 通常、`Get started` などの 1 つまたは 2 つの単語 | トーン、理想的な長さなどについて、具体的なガイダンス（2～5 のガイドライン）を提供します。以前に成功した CTA を _例_ セクションに追加して、出力の品質を向上させます。<br>_例_:「終了句読点を使用しない」 |
