...
| Call-to-action（CTA） | メール、メタ、バナー、ディスプレイ広告 | （Call to action）読み手に与えられる指示で、回答を促すもの。 通常、`Get started` などの 1 つまたは 2 つの単語 | トーン、理想的な長さなどについて、具体的なガイダンス（2～5 のガイドライン）を提供します。 以前に成功した CTA を _例_ セクションに追加すると、品質の出力が向上します。<br>_例_:「終了句読点を使用しない」 |
