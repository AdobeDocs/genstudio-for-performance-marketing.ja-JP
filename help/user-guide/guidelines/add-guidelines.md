...
>[!TIP]
>
>自分が作成したブランドのみを表示する場合は、[!DNL Brands] フィルター（funnel アイコン **から「** 自分が作成したブランド」を選択します。
...
[!DNL Audiences] は、パラメーターペインの [_[!DNL Create]_&#x200B;ワークフロー &#x200B;](../create/overview.md#templates) にドロップダウンとして表示されます。_[!DNL Audiences]_ は、両方のガイドラインを使用する場合に _[!DNL Personas]_&#x200B;に特異性を追加できますが、個別に効果的に使用することもできます。
