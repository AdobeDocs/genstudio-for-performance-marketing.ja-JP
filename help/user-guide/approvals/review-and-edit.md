...
* **承認要求のリストからレビュー用ドラフトにアクセス**。 複数のコンテンツの下書きを確認するように求められた場合、通知メールには「**[!UICONTROL すべての通知を表示]**」ボタンが含まれています。 このボタンをクリックすると、他のAdobe CX Enterprise製品から有効にした承認リクエストや通知など、受信したすべての通知を表示するページに移動します。
