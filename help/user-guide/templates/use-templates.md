...
次に、GenStudio for Performance Marketingがコンテンツを生成する場所を示すプレースホルダーを使用して [ テンプレートをカスタマイズ ](/help/user-guide/templates/customize-template.md) します。 [ リポジトリに ](#add-a-template) テンプレートを追加 [!DNL Content] し、テンプレートを検証します。 コードエディターを使用して軽微な修正を加えます。
