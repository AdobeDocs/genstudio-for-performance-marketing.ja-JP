...
_[!UICONTROL チェックで検出されたフィールド]_&#x200B;のペインが更新され、変更が反映されます。 フィールドが正しく入力されていることを確認したら、**[!UICONTROL 次へ]**&#x200B;をクリックして、テンプレートのアップロードを続行します[3&rbrace;。](/help/user-guide/templates/use-templates.md#add-a-template)
