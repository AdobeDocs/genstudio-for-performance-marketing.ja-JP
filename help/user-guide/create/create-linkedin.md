...
1. 「_パラメーター_」セクションで、ガイドライン（[!DNL Brands]、[!DNL Personas]、[!DNL Products]）を選択して、コンテンツの作成を通知します。
   ...
   ![ ペルソナを選択 ](/help/assets/persona-select-linkedin2.png){width="50%" align="center"}
...
2. [ バリアントを手動で改訂 ](#revise-generated-linkedin-ads) し、完了したコンテンツチェックとバリアントが確実に密接に連携するようにします。
