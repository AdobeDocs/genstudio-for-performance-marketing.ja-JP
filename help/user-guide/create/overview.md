...
<tr style="border: 0;">
   ...
   <td align="center" valign="top" width="100">
      ...
      <img alt="コンテンツの新規作成" src="../../assets/icons/icon-create.svg" width="35">
...
「今日は何を作成しますか？_で生成するチャネルを選択し_ 後 セクションでは、コンテンツ生成で使用するために、ブランドが承認したテンプレートにアクセスできます。 テンプレートを使用すると、コンテンツ作成プロセスを即座に開始でき、定義済みのブランドアイデンティティとの連携が保たれます。
...
GenStudio for Performance Marketingでは、各バリエーションに対して[ ブランドガイドライン ](/help/user-guide/guidelines/brands.md)、プラットフォームガイドライン、および[ アクセシビリティ標準](/help/user-guide/guidelines/overview.md#compliance)に対して[ コンテンツチェック ](/help/user-guide/guidelines/brand-validation.md#content-check-panel)を実施し、[!DNL Brand]、プラットフォーム、アクセシビリティ標準で最大限に満たしていることを確認します。 [ コンテンツチェック ](/help/user-guide/guidelines/brand-validation.md#content-check-summary)情報は、生成されたコンテンツに対して使用でき、包括的なコンテンツチェックとテキストと画像間の一貫性への準拠を示します。 この情報を使用して、生成されたエクスペリエンスを改訂または改善し、ブランドとさらに良く一致させることができます。
