...
description: GenStudio for Performance Marketing用GenStudio Photoshopのインストール、設定、使用方法について説明します。
...
GenStudio Photoshopでは、Adobe Photoshopにパネルが追加され、ブランドに即したコンテンツを生成できます。
...
>[!VIDEO](https://video.tv.adobe.com/v/3478821?captions=jpn&learn=on)
...
1. Adobe Exchangeで&#x200B;**GenStudio Photoshop**&#x200B;を検索します。
...
Figma フレームは、Photoshop ドキュメントに変換し、GenStudio Photoshopで使用するために書き出すことができます。 フレームの変換方法については、Figma プラグインのページの [Figma フレームをPhotoshopに変換する &#x200B;](figma-plugin.md#convert-figma-frames-to-photoshop) の節を参照してください。
