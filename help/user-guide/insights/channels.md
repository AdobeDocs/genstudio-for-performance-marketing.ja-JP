...
| **[!UICONTROL CPM ]**<br>_1 千あたりのコスト_ | 広告キャンペーンの広告インプレッション 1000 件ごとのコスト。 <br>**計算**:（合計金額 `spent` を `impressions` で割った値） x 1000 | 特に、クリックスルー率が高い場合は、値を小さくすると、コスト効率の高い表示を示す可能性があります。 |
