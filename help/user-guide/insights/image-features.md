...
| カメラアングル | カメラが被写体を捉える遠近感は、見る人のイメージやイメージの見方を左右します。 画像スタイルが `photograph` の場合、この特性が識別されます。 | `Low angle`、`High angle`、`Eye level`、`Neutral angle`、`Bird's eye view`<p>`eye level` の例：<p>![ 眼の高さ ](/help/assets/category/image-camera-angle.png " 異なる角度から座っている人 "){width="200" zoomable="yes"} |
