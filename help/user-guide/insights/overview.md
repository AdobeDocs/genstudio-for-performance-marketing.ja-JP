...
Insights でサポートされているチャネルには、Meta、LinkedIn、TikTok、DV360、Innovid などがあります。

Meta、LinkedIn およびTikTokは、キャンペーン、広告、メディアおよび属性を完全に可視化します。 DV360 および Innovid は現在、より限定的なデータ範囲を提供しています。

現時点では、DV360 および Innovid のメディアデータは使用できません。つまり、これらのチャネルの「属性」タブも表示されません。 「属性」タブは、メディアレベルのデータに応じて、エクスペリエンスから抽出された特性を表示します。

この制限は、GenStudio for Performance Marketingの問題ではなく、有料メディアプラットフォーム自体の制約によるものです。
...
[[!DNL Insights] _[!UICONTROL &#x200B; キャンペーン &#x200B;]_&#x200B;ビュー &#x200B;](campaigns.md) はデフォルトのビューで、目標、予算、開始日、アクティビティなどのアクティブなキャンペーンの詳細のリストが表示されます。 GenStudio for Performance Marketingが統計データの受信を開始できるように、[&#x200B; チャネルアカウントを接続 &#x200B;](/help/user-guide/connectors/connect-channel.md) してください。
