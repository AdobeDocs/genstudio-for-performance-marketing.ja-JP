...
[[!DNL Insights] _[!UICONTROL  キャンペーン ]_ビュー ](campaigns.md) はデフォルトのビューで、目標、予算、開始日、アクティビティなどのアクティブなキャンペーンの詳細のリストが表示されます。 GenStudio for Performance Marketingが統計データの受信を開始できるように、[ チャネルアカウントを接続 ](/help/user-guide/connectors/connect-channel.md) してください。
