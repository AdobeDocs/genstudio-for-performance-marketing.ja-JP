...
| **[!UICONTROL プレースメント]** | 広告 [ プレースメント ](#ad-placements) の数、キャンペーンにエクスペリエンスが表示された場所。 | プレースメントを使用すると、オーディエンスのリーチが向上します。 |
...
| **[!UICONTROL CPM ]**<br>_1 千あたりのコスト_ | エクスペリエンスプレースメントの広告インプレッション 1000 件ごとのコスト。<br>**計算**：合計金額 `spent` リーチで割り、さらに 1,000 を掛けます | 特に、クリックスルー率が高い場合は、値を小さくすると、コスト効率の高い表示を示す可能性があります。 |
