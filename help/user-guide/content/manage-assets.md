...
承認されたエクスペリエンスは、_[!UICONTROL エクスペリエンス]_ ギャラリーまたはエクスペリエンスの詳細ビューから、1つ以上の言語に翻訳できます。 [体験の翻訳とローカライズ ](/help/user-guide/create/translate-experiences.md#translate-from-content)を参照してください。
