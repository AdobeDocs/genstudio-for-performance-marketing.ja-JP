...
1. （オプション）のアクティベートを選択する場合は、プラットフォームを選択して [!DNL Activate] ワークフローを続行するように求められる場合があります。 [ アクティブ化 ](/help/user-guide/activation/overview.md) を参照してください。

1. 「**[!UICONTROL ダウンロード]**」をクリックします。

1. _ダウンロード_ ポップアップで、使用可能な形式から選択します。
