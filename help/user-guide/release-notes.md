...
静的なLinkedIn広告に使用するのと同じエンドツーエンドのアクティベーションフローに従って、1つのビデオアセット [&#128279;](/help/user-guide/activation/activate-linkedin-ad.md)を使用するLinkedIn広告エクスペリエンスをGenStudio for Performance MarketingからLinkedIn Campaign Managerにアクティベートできるようになりました。
